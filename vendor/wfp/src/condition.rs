...
use windows_sys::Win32::NetworkManagement::WindowsFilteringPlatform::{
    ...
    FWPM_CONDITION_INTERFACE_INDEX, FWPM_CONDITION_IP_LOCAL_ADDRESS,
...
pub enum ConditionField {
    ...
    LocalInterface,
    /// Numeric local interface index for the connection.
    InterfaceIndex,
}
...
impl ConditionField {
    ...
    pub fn guid(&self) -> &GUID {
        match self {
            ...
            Self::InterfaceIndex => &FWPM_CONDITION_INTERFACE_INDEX,
        }
    }
}

/// Builds an equality condition for a numeric local interface index.
#[must_use]
pub fn interface_index_condition(index: u32) -> Condition {
    ConditionBuilder::default()
        .field(ConditionField::InterfaceIndex)
        .match_type(MatchType::Equal)
        .value_u32(index)
        .build()
        .expect("interface-index condition is complete")
}
