...
impl TransportConfig {
    ...
    /// Maximum DATAGRAM frame size to assume when the peer omits the transport parameter.
    ///
    /// This is intended only for application protocols whose peers deliberately omit the
    /// parameter while still guaranteeing DATAGRAM receive support. The default is `None`.
