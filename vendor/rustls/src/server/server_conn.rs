...
pub struct ClientHello<'a> {
    ...
    /// Whether this is a successfully decrypted ECH inner ClientHello.
...
pub struct ServerConfig {
    ...
    /// ECH server keys used to decrypt Encrypted ClientHello offers.
...
mod connection {
    ...
    impl ServerConnection {
        ...
        /// Returns information about an accepted ECH offer after ClientHello processing.
        pub fn ech_accepted(&self) -> Option<&crate::server::ech::EchFrontendInfo> {
            self.inner.core.data.ech_accepted()
        }
...
impl Accepted {
    ...
    pub fn into_connection(
        ...
        let new = match state.with_certified_key(self.sig_schemes, ch, &self.message, None, &mut cx)
        {
            Ok(new) => new,
...
pub struct ServerConnectionData {
    ...
    pub(super) ech_accepted: Option<super::ech::EchFrontendInfo>,
}
